 ...
 * Sources     : CSCI 21 course material
 */
...
int main()
{
  ...
  cout << "Enter a number of pennies:" << endl;
  
  cin >> change;
  
  MakeChange(change, quarters, dimes, nickels, pennies);
  
  cout << "Your change is paid with " << quarters << " quarters, " << dimes << " dimes, "
    << nickels << " nickels, " << pennies << " pennies." << endl;
  ...
  cout << "Someone is being fired out of a cannon. Enter an initial velocity." << endl;
  
  cin >> velocity;
  
  cout << "Enter a launch angle." << endl;

  cin >> angle;
  
  cout << "Distance is " << LaunchHumanCannonball(velocity, angle) << endl;
