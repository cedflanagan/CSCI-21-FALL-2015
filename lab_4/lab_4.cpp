...
int main()
{
  cout << "MakeString(\"Value\", 32.6, \'=\') : " << MakeString("Value", 32.6, '=') << endl;
  
  cout << "StringToInt(\"55\") + 2 : " << StringToInt("55") + 2 << endl;
  
  cout << "StringToDouble(\"5.5\") + 2.7 : " << StringToDouble("5.5") + 2.7 << endl;
  
  cout << "StringToChar(\"G\") : " << StringToChar("G") << endl;
  
  cout << "StringToBool(\"Three\") : " << StringToBool("Three") << endl;
